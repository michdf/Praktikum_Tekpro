...
public abstract class AbstractStoreEmployee implements Employee, Store {
    ...
    /**
     * Calculates the tax to be paid by the employee based on their earnings.
     *
     * @param earnings The total earnings of the employee.
     * @return The tax amount to be paid.
     */
    public abstract double calculateTax(double earnings);
